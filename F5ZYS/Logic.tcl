...
#La fete du jour
if {$cmd == "10"} {
puts "Lecture de message d'information si présent"
read_info
...
if {![file exists $fichier]} {
    ...
    # "Tension mesuree : 0.00 V"

    # Extraire uniquement la valeur numérique
    # Expression régulière : capture un nombre flottant
    if {[regexp {([0-9]+\.[0-9]+)} $ligne match valeur]} {
        set alim $valeur
    } else {
        # Si la ligne ne contient pas de tension valide
        set alim "0.00"
    }
}
# Affichage et actions SVXCard
